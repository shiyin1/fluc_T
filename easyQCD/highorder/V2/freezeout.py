...
ax1.plot(Andro[:,0],Andro[:,1]**0.5,linewidth=2,alpha=0.8,label=r'$\mathrm{Freeze-out:\,Andronic\,et\,al.}$') 
ax1.plot(SFI[:,0],SFI[:,1]**0.5,linewidth=2,alpha=0.8,label=r'$\mathrm{Freeze-out:\,STAR\,Fit\,I}$') 
...
fig.savefig("./c2_freezeout_QCD.pdf")