MODULE DTVDIFF_MOD
CONTAINS
SUBROUTINE DTVDIFF1(K,ETAPSI,ETAPHI,MP2K,MS2K,MF2K,KAPPAK,HK,GK,L,LB,DTVD1L,DTVD1LB)
!THIS SUBROUTINE CALCULATE VARIOUS DIFFERENTIAL KERNAL CORRESPONDING 0<K<K_UV
  ...
  REAL(16),INTENT(IN) :: KAPPAK,HK,GK,L,LB
  ...
  REAL(16) :: ETAPSID1L,ETAPSID1LB,ETAPHID1L,ETAPHID1LB
