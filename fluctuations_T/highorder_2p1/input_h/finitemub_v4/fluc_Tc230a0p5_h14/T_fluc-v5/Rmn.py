...
ax1.set_xlabel(r'$T\,[\mathrm{MeV}]$', fontsize=15, color='black')
ax1.legend(loc=0,fontsize='10',frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1,scatterpoints=1)
ax1.axis([50,300,-5000/1000,1000/1000])
...
#fig=plt.figure()
ax1=fig.add_subplot(111)
ax1.plot(T,c6mub0/c2mub0**5/100000,'g',linewidth=1.5,alpha=0.7,zorder=3,label=r'$\mu_B=0$')
ax1.plot(T,c6mub100/c2mub0**5/100000,'r',linewidth=1.5,dashes=[5,2],alpha=0.7,zorder=4,label=r'$\mu_B=100\,\mathrm{MeV}$')
ax1.plot(T,c6mub200/c2mub0**5/100000,'b',linewidth=1.5,dashes=[4,1,2,1],alpha=0.7,zorder=5,label=r'$\mu_B=200\,\mathrm{MeV}$')
ax1.plot(T,c6mub300/c2mub0**5/100000,'m',linewidth=1.5,dashes=[2,2],alpha=0.7,zorder=6,label=r'$\mu_B=300\,\mathrm{MeV}$')
ax1.plot(T,c6mub400/c2mub0**5/100000,'y',linewidth=1.5,dashes=[3,1,2,1],alpha=0.7,zorder=7,label=r'$\mu_B=400\,\mathrm{MeV}$')
ax1.plot(T,c6mub500/c2mub0**5/100000,'c',linewidth=1.5,dashes=[2,1],alpha=0.7,zorder=8,label=r'$\mu_B=500\,\mathrm{MeV}$')
ax1.plot(T,c6mub550/c2mub0**5/100000,'k',linewidth=1.5,dashes=[1,1],alpha=0.5,zorder=9,label=r'$\mu_B=550\,\mathrm{MeV}$')
ax1.set_ylabel(r'$R_{62}\,[\times 10^5]$', fontsize=17, color='black')
ax1.set_xlabel(r'$T\,[\mathrm{MeV}]$', fontsize=15, color='black')
ax1.legend(loc=0,fontsize='10',frameon=True,shadow=True,handlelength=3.,borderpad=0.5,borderaxespad=1,numpoints=1,scatterpoints=1)
ax1.axis([50,300,-0.2,2])
