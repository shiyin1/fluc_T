program QM
  ...
  real(16) dcd0mu(mmax),dcd1mu(mmax),dcd2mu(mmax),dcd3mu(mmax),dcd4mu(mmax)
  real(16) dcd5mu(mmax),dcd6mu(mmax),dcd7mu(mmax),dcd8mu(mmax)
  ...
  do jl=1,9
    j=jl
    write(fileV1,'(a10,i1,a4)')'../dataB/V',jl,'.dat'
  ...
  do jl=10,munum
    j=jl
    write(fileV2,'(a10,i2,a4)')'../dataB/V',jl,'.dat'
  ...
  do i=1,Tnum
    !T=(Ti+real(i-1,kind=16)*dT)+_delta
    pre_com=P_res(i,:)
    ...
    chi(8,i)=chebev(mu_down,mu_up,dcd7mu,mmax,0.Q+00)!*T**3
    chi(9,i)=chebev(mu_down,mu_up,dcd8mu,mmax,0.Q+00)!*T**4
  end do
  ...
  open(unit=51,file='../data/chi7.dat')
  do i=1,Tnum
    write(51, *)chi(8,i)
  end do
  close(51)

  open(unit=51,file='../data/chi8.dat')
  do i=1,Tnum
    write(51, *)chi(9,i)
  end do
  close(51)
