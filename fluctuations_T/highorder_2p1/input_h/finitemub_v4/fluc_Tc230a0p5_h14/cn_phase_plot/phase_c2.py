...
vd=0.019
vu=0.0285
im=ax2.imshow(c2data.T, cmap=cmap_custom,interpolation='nearest',vmin=vd,vmax=vu,zorder=1,extent=[0, 555, 21, 300], origin='lower', aspect=1.7)
...
for spine in ax2.spines.values():
    spine.set_zorder(11)
ax2.tick_params(which='both', zorder=11)
