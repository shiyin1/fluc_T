subroutine nfdx(T,l,lb,nf0,nf1,nf2,nfd0x,nfd1x,nfd2x,nfd3x,nfd4x,nfd5x)
!Calculate the derivatives of fermi distribution functions
  implicit none

  real(16) l,lb,nf0(3),nf1(3),nf2(3)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine nbdx(nb,T,nbd1x,nbd2x,nbd3x,nbd4x,nbd5x)
!Calculate the derivatives of boson distribution functions
  implicit none
