...
!  P=Pdata(:,iT)
  ...
  h=p(10)+p(9)*x+p(8)*x**2+p(7)*x**3+p(6)*x**4+p(5)*x**5+p(4)*x**6+p(3)*x**7+p(2)*x**8+p(1)*x**9

  P=Pdata(:,1)

  hs=p(10)+p(9)*x+p(8)*x**2+p(7)*x**3+p(6)*x**4+p(5)*x**5+p(4)*x**6+p(3)*x**7+p(2)*x**8+p(1)*x**9
end
