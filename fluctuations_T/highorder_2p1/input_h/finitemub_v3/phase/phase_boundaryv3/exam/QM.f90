program QM
  ...
  muk=0.Q+00
  muBi=0.Q+0+real(J*15,kind=16)
  
  T_up=20.Q+0
  T_down=-T_up
  T_delta=0.Q+0!cos(pi*(real(J,kind=16)-0.5Q+00)/real(Tnum,kind=16))*(0.5Q+00*(T_up-T_down))+0.5Q+00*(T_up+T_down)
  dT=1.Q+00
  muS=0.Q+0
  muB=muBi
  muq=0.Q+00
  mu=muB/3.Q+0
    ...
    do i=1,300
      iT=i
      T=(Ti+real(i-1,kind=16)*dT)!+T_delta
