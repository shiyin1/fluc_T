...
!order of chebyshev polynomial
  ...
  mudelta=0.!cos(pi*(j-0.5Q+00)/real(jmumax,kind=16))*(0.5Q+00*(mu_up-mu_down))+0.5Q+00*(mu_up+mu_down)
  ...
  do i=1,iTmax
    ...
    write(*,"('fpi=', f15.7, t25, 'mPion=', f15.7)")mf*hc,mSigma*hc
